...
class ProductPositionUpdateListener {
  static final AppLog _log = AppLog('product_pos_listener');
  ...
  Future<void> _updatePosition(PositionUpdatedEventDto dto) async {
    ...
    _log.i(
      'Position update received; updating local product registry '
    ...
    try {
      ...
      _log.e(
        'Failed to update local product positions from PositionUpdatedEventDto',
        error: e,
        stackTrace: st,
      );
    }
