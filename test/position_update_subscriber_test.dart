...
void main() {
  ...
  test(
    'subscribes and publishes PositionUpdatedEventDto when payload matches tag+tableName',
    () async {
      final em = EventManager()..init();
  ...
  test(
    'ignores PositionUpdatedEventDto when payload does not match tag+tableName',
    () async {
      final em = EventManager()..init();
      final serviceName = 'svcA';
      final tag = 't1';
  ...
  test(
    'publishes PositionUpdateSseIdMismatchEvent and invokes callback on mismatch',
    () async {
      final em = EventManager()..init();
      final serviceName = 'svcA';
      final tag = 't1';
      ...
      final mismatch = SseIncrementalIdMismatch(
        ...
        frame: SseFrame.fromFields(const {
          'id': ['9'],
        }),
      );
